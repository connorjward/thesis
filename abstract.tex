...
To ease this burden, a number of simulation frameworks make use of high-level domain-specific languages (DSLs) that mirror the underlying mathematics.
...
The expressive power, and hence to some extent the value, of a DSL as a tool for computation hinges upon the existence of the right abstractions.
...
This work presents a suite of novel abstractions that encapsulate the processes of storing and accessing complex data layouts on unstructured meshes, as well as an implementation of said abstractions in the new Python library \pyop3.
