...
% TODO: Also discuss the data model which is DMPlex + Section. It's ragged
% and cannot tell if things are cells or edges etc. Supports renumbering.
% Both DMPlex and PyOP2 are not able to flexibly add further shape.
% Maybe this section needs a bit of a reordering, do we introduce axis trees and then compare
% to PyOP2/DMPlex or do we introduce the latter two and describe their shortcomings?
