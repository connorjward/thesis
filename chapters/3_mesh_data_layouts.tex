...
\begin{figure}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \begingroup  % used to isolate settings changes
      % see: https://www.overleaf.com/learn/latex/Questions/How_do_I_change_column_or_row_separation_in_LaTeX_tables
      ...
      \begin{tabular}{c|c}
        ...
        % \{$a$, $b$, $c$\} & $\lbrac \lbrac 0, 1 \rbrac, \lbrac 1, 3 \rbrac \rbrac \lbrac i_a, i_b \rbrac + i_c$ \\
        % \{$a$, $b$, $c$\} & $\lbrac \lbrac 0, 1 \rbrac, \lbrac 1, 3 \rbrac \rbrac_{i_a, i_b} + i_c$ \\
      \end{tabular}
    \endgroup
    \caption{TODO}
