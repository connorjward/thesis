...
% we have the data structures and loop expressions for assembly - things work!!!

% now go onto other demonstrator applications that investigate this in more detail
