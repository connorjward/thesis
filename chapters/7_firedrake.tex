...
% show an inline diagram of the data layout and the flip needed - want the original one done first

% consider simplest possible, P3 and disregard non-edge DoFs

% given a permutation array [[0, 1], [1, 0]]
% and orientation [[0, 1, 0]]

% cell = 0
% dat[closure(cell)][:, [[0, 1], [1, 0], [0, 1]]]

% cell = 0
% dat[closure(cell)][:, perms[[0, 1, 0]]]

% cell = 0
% dat[closure(cell)][:, perms[ort[cell]]]

% thus, we can now represent the permutation transformation entirely symbolically

% why is this good?
% easier to extend? expressed at runtime -> codegen more difficult things...

% now how to extend to general transformations
