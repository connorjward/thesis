...
For multi-field problems such as the Stokes example in \cref{chapter:introduction} \pyop2 has \emph{mixed data sets}, which are simply a collection of regular data sets.
