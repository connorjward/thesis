...
To transfer function data, PETSc composes the point star forest with a \ccode{PetscSection} to produce a new star forest (\cref{fig:star_forest_dof}).
