...
The algorithm is very similar to the approach taken by \pyop2 except the loop over arrays (line 2) is omitted and the function \textsc{CollectStencil} is hard-coded as the point's closure (\cref{sec:dmplex_queries}).
