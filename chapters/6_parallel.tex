...
To avoid copying data between ghost-inclusive and ghost-free representations of an array, \pyop3 reorders the DoFs so that ghost entries are always stored after owned ones.
...
% HERE!!! maybe best to start with "With axis trees..."
% not sure how to fit the "constrained points" bit into things - perhaps later when we discuss regions???
