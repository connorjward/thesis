...
\begin{table}
  ...
  \begin{tblr}{|[1pt]l|[1pt]c|[1pt]c|[1pt]c|[1pt]c|[1pt]c|[1pt]c|[1pt]c|[1pt]}
    ...
    \hline[1pt]
    Data layout flexibility & \mycross & \mycross & \mycross & $\sim$ & $\sim$ & \mycross & \mytick \\
    \hline[1pt]
...
OP2 alternates between AoS and SoA layouts depending on the target backend and whether or not the data is addressed directly or indirectly.
More complex layouts are not possible.
