...
\todo[inline]{Rewrite this bit. I think this step should be taken later, we should drop surface integral terms at a later point.}
...
\todo[inline]{Replace $V$ with $V_{0,h}$}
% describe forward subst to remove constrained DoFs from the system somewhere! ref. Emma's dissertation

% TODO: IMPORTANT! how are the boundary terms dropped if v is from V not V_0???

\todo[inline]{Modify RHS and spaces to get BCs done correctly.}
