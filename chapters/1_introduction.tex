...
The article would focus on the enhanced capabilities of \pyop3 compared to existing frameworks such as \pyop2, and the sorts of new numerical methods and low-level transformations that are now available.
