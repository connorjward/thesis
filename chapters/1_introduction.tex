...
It is possible to employ \emph{hybrid} memory models that combine both paradigms (e.g.~\cite{langeAchievingEfficientStrong2013}), but that is considered out of scope for this work.
