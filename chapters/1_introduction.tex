...
% we want an abstraction that better encompasses a wide range of different numerical methods and optimisations!
% many of these packages target a particular numerical method (FEM, FDM), we want to be more generic!
% hence the focus on the more general problem of mesh stencil computations.
