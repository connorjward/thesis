...
%     \centering
%     \includegraphics{scott_vogelius_axis_tree.pdf}
%     \caption{
...
\begin{itemize}
  ...
  \item
    % NOTE: this is probably a bad thing to specify, they are mutable in a sense that indexed
    % trees are not.
...
This is described in \cref{chapter:indexing}. %FIXME: no, in Firedrake chapter
