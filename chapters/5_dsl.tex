...
\begin{listing}
  ...
  \end{minipage}
  \caption{
    \pyop3 code evaluating a local kernel (\pycode{kernel}) within a loop over the entries of axis $a$.
...
This extra step is not needed in \pyop2 because the `compressed' maps are always passed in as input.
