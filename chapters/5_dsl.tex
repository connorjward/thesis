...
Having generated a loopy kernel, \pyop3 instructs loopy to generate a C string from it (\cref{listing:c_string_ex1}).
...
% NOTE: Can probably omit this - same as above really
\begin{listing}
  \centering
...
% uses PETSc, support for different formats - restricted dtype
...
% \section{Expressing computations}
% \label{sec:dsl}
%
