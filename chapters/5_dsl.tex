...
\end{pyinline}
Here we loop over the entries in \pycode{axis_a} and apply local kernel \pycode{kernel}, whose implementation is externally provided as a loopy kernel, to indexed arguments \pycode{dat0} and \pycode{dat1}.
