...
\begin{figure}
  \begin{subfigure}{.3\textwidth}
    \includegraphics[width=\textwidth]{lagrange_element_2.pdf}
    \caption{P2, TODO}
  \end{subfigure}
...
\begin{figure}
  ...
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{lagrange_element_3.pdf}
  \end{subfigure}
  %
  \hfill
  %
  \begin{subfigure}{.4\textwidth}
    \includegraphics[width=\textwidth]{lagrange_element_2_dg.pdf}
  \end{subfigure}
  %
  \hfill
  %
