...
% NOTE: Too casual "does things".
Just as axis trees can be regarded as a generalisation of numpy arrays, indexing arrays in \pyop3 is, as far as possible, analogous to indexing operations in numpy.
Before diving into how \pyop3 does things it is therefore instructive to review how indexing is done in numpy.
