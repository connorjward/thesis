...
\drawTreeNode{(space)}{(1,\yshift)}{$\textnormal{slice}(\pycode{"space"},\ \{ \component{space0}{\pycode{"Vh"}},\ \component{space1}{\pycode{"Qh"}} \})$};

\tikzmath { \yshift = \yshift - 2; }

\drawTreeNode{(mesh0)}{(-3,\yshift)}{$\textnormal{map}(\closure(c),\ \{ \component{mesh00}{\pycode{"vertex"}},\ \component{mesh01}{\pycode{"edge"}},\ \component{mesh02}{\pycode{"cell"}} \})$};
\underlineComponent{space}{space0};
\drawTreeConnector{space}{space0}{(mesh0)};

\drawTreeNode{(mesh1)}{(5,\yshift)}{$\textnormal{map}(\closure(c),\ \{ \component{mesh10}{\pycode{"vertex"}},\ \component{mesh11}{\pycode{"edge"}},\ \component{mesh12}{\pycode{"cell"}} \})$};
