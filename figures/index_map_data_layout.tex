...
\drawCompositionCircle{(5.7, -.5)};

% --- INDEX TREE ---

\coordinate (origin) at (6.4,0);

\drawTreeNode{(top)}{(origin)}{map($f(p)$, \{ \component{top0}{$a$} \})};
\drawTreeNode{(bottom)}{($(origin)+(.5,-2)$)}{$\textnormal{slice}(b,\ \{ \pycode{[::]} \})$};
...
% top
\drawWhiteDof{(origin)}{\scriptsize$c_0/f_0(p)$};
\drawWhiteDof{($(origin)+(1,0)$)}{\scriptsize$c_1/f_1(p)$};
\drawWhiteDof{($(origin)+(2,0)$)}{\scriptsize$c_2/f_2(p)$};
