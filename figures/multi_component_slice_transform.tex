...
\drawTreeNode{(top)}{(origin)}{$\textnormal{slice}(a: \{ \component{top0}{x: \pycode{[::2]}},\ \component{top1}{y: \pycode{[1::]}} \})$};
\drawTreeNode{(bottom0)}{($(origin)+(0,-2)$)}{$\textnormal{scalar}(b,\ \pycode{1})$};
\drawTreeNode{(bottom1)}{($(origin)+(2.2,-2)$)}{$\textnormal{slice}(c,\ \{ \pycode{[1::]} \})$};
